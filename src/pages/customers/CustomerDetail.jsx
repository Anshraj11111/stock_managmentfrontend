    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-xl font-medium shadow-md hover:shadow-lg transition-all"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 rounded-2xl border border-red-200 dark:border-red-800 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-semibold text-gray-700 dark:text-gray-300">Total Due</h3>
          </div>
          ...
          {parseFloat(customer.total_due) > 0 && (
            <button
              ...
              className="mt-4 w-full flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-lg font-medium transition-all duration-300 shadow-md hover:shadow-lg"
            >
      ...
      <div className="bg-white dark:bg-secondary-900 rounded-2xl border border-secondary-200 dark:border-secondary-800 p-6">
        <h2 className="text-xl font-bold text-secondary-900 dark:text-secondary-100 mb-6 flex items-center gap-2">
                  ...
                  <div className="flex-1">
                    ...
                    {entry.reference_type === 'bill' && entry.reference_id ? (
                      <button
                        ...
                        className="flex items-center gap-1 mt-1 text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 font-semibold hover:underline transition-colors"
                      >
      ...
      {showBillModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-md animate-in fade-in duration-200">
          <div className="bg-gradient-to-br from-white via-gray-50 to-indigo-50 dark:from-gray-900 dark:via-gray-900 dark:to-indigo-950 rounded-3xl shadow-2xl max-w-4xl w-full max-h-[95vh] overflow-hidden animate-in slide-in-from-bottom-4 duration-300 border border-gray-200 dark:border-gray-800">
            
            {/* Premium Header with Gradient */}
            <div className="sticky top-0 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 dark:from-indigo-700 dark:via-purple-700 dark:to-pink-700 p-8 flex items-center justify-between z-10 shadow-lg">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-indigo-100 text-sm mt-1">Complete transaction details</p>
                </div>
              </div>
              <button
                onClick={() => {
            ...
            <div className="overflow-y-auto max-h-[calc(95vh-120px)] p-8">
              {loadingBill ? (
                <div className="flex flex-col items-center justify-center py-20">
                  <Loader size="lg" />
                  <p className="mt-4 text-gray-600 dark:text-gray-400 font-medium">Loading bill details...</p>
                </div>
              ) : selectedBill ? (
                <div className="space-y-8">
                  
                  {/* Premium Bill Header Card */}
                  <div className="bg-gradient-to-br from-indigo-500 to-purple-600 dark:from-indigo-600 dark:to-purple-700 rounded-2xl p-8 shadow-xl text-white">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                      <div className="space-y-2">
                        <p className="text-indigo-100 text-sm font-medium uppercase tracking-wide">Bill Number</p>
                        <p className="text-3xl font-black">
                          #{selectedBill.id}
                        </p>
                      </div>
                      <div className="space-y-2">
                        <p className="text-indigo-100 text-sm font-medium uppercase tracking-wide">Date</p>
                      ...
                      <div className="space-y-2">
                        <p className="text-indigo-100 text-sm font-medium uppercase tracking-wide">Status</p>
                      ...
                      <div className="space-y-2">
                        <p className="text-indigo-100 text-sm font-medium uppercase tracking-wide">Total Amount</p>
                        <p className="text-3xl font-black">
                      ...
                      <div className="grid grid-cols-2 gap-6">
                        {selectedBill.customer_name && (
                          <div className="space-y-1">
                            ...
                            <p className="text-lg font-bold text-gray-900 dark:text-white">{selectedBill.customer_name}</p>
                          </div>
                        )}
                        {selectedBill.customer_phone && (
                          <div className="space-y-1">
                            ...
                            <p className="text-lg font-bold text-gray-900 dark:text-white">{selectedBill.customer_phone}</p>
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <span className="px-4 py-2 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 rounded-full text-sm font-bold">
                    ...
                    <div className="space-y-3">
                      {(selectedBill.BillItems || selectedBill.items || []).map((item, index) => (
                        <div
                          key={index}
                          className="group flex justify-between items-center p-5 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:border-indigo-400 dark:hover:border-indigo-500 hover:shadow-md transition-all duration-200"
                        >
                          <div className="flex-1">
                  ...
                  <div className="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-900 rounded-2xl p-8 border-2 border-indigo-200 dark:border-indigo-800 shadow-xl">
                    <div className="space-y-4">
                      ...
                      <div className="border-t-3 border-indigo-300 dark:border-indigo-700 pt-4 mt-4"></div>
                      
                      <div className="flex justify-between items-center bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-700 dark:to-purple-700 rounded-xl p-6 shadow-lg">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                      ...
                      <div className="space-y-3">
                        {selectedBill.Payments.map((payment, index) => (
                          <div
                            key={index}
                            className="flex justify-between items-center p-5 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl border-2 border-green-200 dark:border-green-800 shadow-sm"
                          >
                            <div>
                              <p className="text-lg font-bold text-gray-900 dark:text-white uppercase tracking-wide">
                      ...
                      {selectedBill.due_amount > 0 && (
                        <div className="mt-4 p-5 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-xl border-2 border-amber-300 dark:border-amber-700 shadow-sm">
                          <div className="flex justify-between items-center">
                            <span className="text-lg font-bold text-amber-800 dark:text-amber-300 uppercase tracking-wide">Remaining Due</span>
