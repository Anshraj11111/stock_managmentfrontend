    ...
    <div className="space-y-4 sm:space-y-6">
        ...
        <div className="flex gap-3">
          ...
          {isOwner && (
            <>
              ...
              <button
                onClick={() => openModal()}
                className="flex items-center justify-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-blue-600 to-blue-600 hover:from-blue-700 hover:to-blue-700 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 text-sm sm:text-base"
              >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
        ...
        {isOwner && (
          ...
          >
            <TrendingUp className="w-6 h-6 sm:w-8 sm:h-8 text-blue-600 dark:text-blue-300 mb-2" />
            ...
            {showValueTooltip && (
              <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-secondary-900 border-2 border-blue-300 dark:border-blue-500 rounded-xl p-4 shadow-xl z-10 animate-in slide-in-from-top-2">
                <p className="text-sm text-blue-700 dark:text-blue-300 font-semibold mb-1">{t('products.exactInventoryValue')}:</p>
                <p className="text-xl sm:text-2xl font-bold text-blue-900 dark:text-blue-300 break-all">
                  ₹{Math.round(stats.totalValue).toLocaleString()}
                </p>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex-1 py-2.5 sm:py-3 bg-gradient-to-r from-blue-600 to-blue-600 text-white rounded-xl font-medium hover:from-blue-700 hover:to-blue-700 transition-colors disabled:opacity-50 text-sm sm:text-base"
                >
